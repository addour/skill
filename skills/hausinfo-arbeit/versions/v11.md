...
Bei Kreuz ist die Reihenfolge fest: Kurz, Sicherheit, bei Bedarf ein kurzer Hinweis, dann Zuständige Stelle mit vollständig ausgeschriebener E-Mail nach Abschnitt 9, zuletzt die Internet-Zeile aus Abschnitt 8. Regel, So machst du es, Wichtig und Begriffe entfallen, weil sie keine Quelle hätten. Eine Kreuz-Antwort ohne zuständige Stelle ist unvollständig und hilft dem Nutzer nicht.
...
Schreib danach die E-Mail vollständig aus, mit Betreff, Anrede, kurzer Schilderung, Verweis auf Dokument und Abschnitt, der offenen Frage und Grußformel. Nenne dabei nie eine E-Mail-Adresse, Telefonnummer oder Postanschrift, die nicht wörtlich in den Unterlagen steht. Steht dort keine, lass die Empfängerzeile weg und schreib, dass der Nutzer die Adresse der genannten Stelle im Intranet nachschlägt. Eine erfundene Adresse sieht echt aus und die Mail kommt nie an. Frag nicht, ob der Nutzer eine Vorlage möchte, sondern liefere sie fertig zum Kopieren. Bei persönlichen und arbeitsrechtlichen Themen weise zusätzlich auf Personalbereich und Personalrat hin.
...
- Habe ich eine E-Mail-Adresse oder Telefonnummer genannt, die nicht belegt ist?
